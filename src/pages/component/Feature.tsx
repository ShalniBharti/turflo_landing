...
const Feature = () => {
  return (
    <div className="bg-[#1C1C1C] text-[#FFFFFF] px-2 py-[70px] md:py-[110px] lg:py-[90px]">
      <div className="container mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-[20px] md:gap-[50px] lg:gap-[100px] xl:gap-[150px] pt-[78px] md:pt-[118px] lg:pt-[108px]">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-[15px] md:text-[21px] lg:text-[21px] font-semibold font-spartan">Game Hosted</div>
          </div>
