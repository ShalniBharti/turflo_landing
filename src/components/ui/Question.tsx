  ...
  return (
    ...
    >
      <div className={`flex justify-between items-center h-[90px] ${isOpen ? '' : ''}`}>
        <p className="font-bold font-spartan text-[18px] text-left leading-[125%] md:text-[22px] md:leading-[100%] lg:text-[24px] lg:leading-[100%] text-[#FFFFFF]">
      ...
      {isOpen && (
        <div className="pb-[25px]">
          <div className="text-[14px] font-quicksand text-left font-semibold leading-[27px] md:text-[14px] lg:text-[18px] text-[#FFF]">
